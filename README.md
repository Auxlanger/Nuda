...
- [**Scopes**](#scopes)
    ...
    - [**s11. Generalization: ma**](#s11.-generalization-ma)
...
Follow the subject with the generalizer **ma**.

#### Notes

Henceforth in this document, unless indicated otherwise, new word roots such as **ma** are assumed to have been rolled (that is, randomly generated by rolling dice). The word **fume** is a noun meaning *book*.

It is ungrammatical to qualify a generalized noun with a decalarative, because a generalization cannot be transformed into a specification. So this is ungrammatical nonsense: **fume ma baki** (*these 'books-in-general'* = nonsense). Remember that **ma**, if present, must end the noun phrase; it cannot be followed by any kind of qualifier or demonstrative.
...
1. **lefu** = tree
1. **lisusu** = language
1. **ma** = generalizes the preceding subject
